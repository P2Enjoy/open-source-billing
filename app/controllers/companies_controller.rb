class CompaniesController < ApplicationController
  ...
  def verify_name_email_uniqueness
    company_emails = params[:newCompany].eql?('new_company') ? Company.pluck(:email) :
                       Company.where.not(id: params[:company_id]).pluck(:email)
    company_names = params[:newCompany].eql?('new_company') ? Company.pluck(:company_name) :
                      Company.where.not(id: params[:company_id]).pluck(:company_name)
